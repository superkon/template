...
<button type="button" class="btn btn-primary navbar-right" onclick="window.open('<?php echo site_url('module/dummy/edit/'.$id) ?>','_self');"><?=lang("button_back")?></button>
...
$(document).ready(function() {
    ...
    "serverSide": true,
    "ajax": {
		"url": "<?php echo site_url('module/dummy/getRecordVersionAjax/'.$id) ?>",
            "type": "POST"
		},
