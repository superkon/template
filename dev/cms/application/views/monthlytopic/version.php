...
<button type="button" class="btn btn-primary navbar-right" onclick="window.open('<?php echo site_url('module/monthlytopic/edit/'.$id) ?>','_self');"><?=lang("button_back")?></button>
...
$(document).ready(function() {
    ...
    "ajax": {
		"url": "<?php echo site_url('module/monthlytopic/getRecordVersionAjax/'.$id) ?>",
            "type": "POST"
		},
