...
<button type="button" class="btn btn-primary navbar-right" onclick="window.open('<?php echo site_url('module/lunisolardates/edit/'.$id) ?>','_self');"><?=lang("button_back")?></button>
...
$(document).ready(function() {
    ...
    "ajax": {
		"url": "<?php echo site_url('module/lunisolardates/getRecordVersionAjax/'.$id) ?>",
            "type": "POST"
		},
