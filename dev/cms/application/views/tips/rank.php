...
<button type="button" class="btn btn-primary navbar-right" onclick="window.open('<?php echo site_url('module/tips/listing/') ?>','_self');"><?=lang("button_back")?></button>
...
$(document).ready(function() {
    ...
    "ajax": {
		"url": "<?php echo site_url('module/tips/getRecordRankAjax') ?>",
            "type": "POST"
		},
    "rowReorder": {
			"selector": 'tr'
  ...
  datatable.on( 'row-reorder', function ( e, diff, edit ) {
      ...
      showLoading();
      $.ajax({
  			url: '<?php echo site_url('module/tips/updateRecordRankAjax') ?>',
  			type: 'POST',
