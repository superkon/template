{
    ...
    "options": {
        ...
        "serverRoot": true,
        "fileRoot": "<?=substr($_SERVER["REQUEST_URI"], 0, strpos($_SERVER["REQUEST_URI"], "cms/assets"))?>uploads/",
        "baseUrl": "<?=substr($_SERVER["REQUEST_URI"], 0, strpos($_SERVER["REQUEST_URI"], "cms/assets"))?>uploads/",
        "logger": false,
